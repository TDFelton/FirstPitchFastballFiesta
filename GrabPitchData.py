...
ball_events = ball_events_subset.to_table(filter = (pads.field('away_team') == "PHD")).to_pandas()
...
lineups = lineups_subset.to_table(filter = (pads.field('away_team') == "PHD")).to_pandas()
